...
[`../../docs/binnacle-core/REQUIREMENTS.md`](../../docs/binnacle-core/REQUIREMENTS.md) and
[`../../docs/binnacle-core/ARCHITECTURE.md`](../../docs/binnacle-core/ARCHITECTURE.md) for the full contract.
...
```bash
uv add "binnacle-core @ git+https://github.com/ianynchen/Binnacle.git#subdirectory=packages/binnacle-core"
# or
pip install "binnacle-core @ git+https://github.com/ianynchen/Binnacle.git#subdirectory=packages/binnacle-core"
```
...
```python
from binnacle_core import BinnacleConfig, DiscoveryConfig
...
```python
import asyncio
from binnacle_core import Actor, Binnacle, BinnacleConfig, NewDecision
...
```python
from binnacle_core import NewDecision, OptionConsidered, Ref
...
```python
from binnacle_core import InvalidResolution
...
```python
from binnacle_core import BinnacleError, IdempotencyConflict, InactiveDomain, UnknownDomain
...
top-level `binnacle_core` package.
...
[`../../docs/binnacle-core/REQUIREMENTS.md` §5](../../docs/binnacle-core/REQUIREMENTS.md) for the full v2 list and
...
- **Precedent over-fetch escalates, but only up to a hard cap.**
  ...
  results (`packages/binnacle-core/src/binnacle_core/application/query.py`).
- **Discovery re-embeds rather than reading back stored vectors.** The
  ...
  `backfill_embeddings()` (`packages/binnacle-core/src/binnacle_core/application/discovery.py`).
